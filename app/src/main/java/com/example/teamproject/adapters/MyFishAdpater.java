...
public class MyFishAdpater extends RecyclerView.Adapter<MyFishAdpater.CustomViewHolder>{
    ...
    public MyFishAdpater(ArrayList<fishListResult> arrayList, Context context) {
